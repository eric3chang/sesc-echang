...
#endif
  void NotifyCompletedTrans(CPU_t cpuID, bool isRead, VAddr address);
  typedef CallbackMember3<Processor,CPU_t,bool,VAddr,&Processor::NotifyCompletedTrans> NotifyCompletedTransCB;

  virtual bool IsBusyWaiting();
  virtual void StopBusyWait();
  virtual void StartBusyWait();
  virtual void StopBusyWaitIn(TimeDelta_t t);
  virtual void BusyWaitFor(TimeDelta_t t);
};
