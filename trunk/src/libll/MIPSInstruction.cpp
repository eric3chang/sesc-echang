				 ...
				 char **envp)
{
  ...
  for(int32_t i=0; i<FakeInst; i++)
  {
	  InstTable[codeSize + i].src1Pool = whichPool(InstTable[codeSize + i].src1);
	  InstTable[codeSize + i].src2Pool = whichPool(InstTable[codeSize + i].src2);
	  InstTable[codeSize + i].dstPool = whichPool(InstTable[codeSize + i].dest);
  }
