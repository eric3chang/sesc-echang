...
public:
  ...
  virtual void purgeInstructionWindow() {};
...
public:
	virtual void StopBusyWait(){ I(0); }
	virtual bool IsBusyWaiting(){ return false; }
	virtual void StartBusyWait(){ I(0); }
	virtual void StopBusyWaitIn(TimeDelta_t t){ I(0);}
	virtual void BusyWaitFor(TimeDelta_t t){ I(0);}
};
