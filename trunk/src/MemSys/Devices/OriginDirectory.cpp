...
void OriginDirectory::HandleReceivedAllInvalidates(Address myAddress)
   {
      ...
      AutoDetermineDestSendMsg(icm,directoryNode,remoteSendTime,
         &OriginDirectory::OnRemoteInvalidationComplete,"HanRecAllInv","RemInvCom");
   }

   void OriginDirectory::SendMemAccessComplete(Address addr, NodeID directoryNode)
   {
      ...
      AutoDetermineDestSendMsg(reply,directoryNode,remoteSendTime,
         &OriginDirectory::OnRemoteMemAccessComplete,"DBRes","RemoteMemAccCom");
   }
...
void OriginDirectory::writeToMainMemory(Address addr, Address generatingPC, size_t size)
   {
	...
	void OriginDirectory::HandleInterventionComplete(const BaseMsg *msgIn, bool isPendingExclusive)
   {
   ...
   */
   ...
   void OriginDirectory::SendInterventionCompleteMsg(const ReadResponseMsg *m, const char *fromMethod)
   {
      ...
      AutoDetermineDestSendMsg(toDir,directoryNodeCalc->CalcNodeID(m->addr),remoteSendTime,
         &OriginDirectory::OnRemoteInterventionComplete,fromMethod,"RemIntervCom");
   }
   ...
   */
   // void OriginDirectory::writeToMainMemory(const BaseMsg* msgIn)
	 ...
	 */
	void OriginDirectory::OnLocalRead(const BaseMsg* msgIn)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnLocalReadResponse(const BaseMsg* msgIn)
	{
		DebugAssert(msgIn)
		...
		if (d.msg->isIntervention)
		{
         ...
         //{
            ...
            AutoDetermineDestSendMsg(forward,d.msg->originalRequestingNode,remoteSendTime+lookupTime,
                  &OriginDirectory::OnDirectoryBlockResponse,"LocalReadRes","DBRes");
            ...
            AutoDetermineDestSendMsg(dirResponse,d.sourceNode,remoteSendTime+lookupTime,
                  &OriginDirectory::OnRemoteReadResponse,"LocalReadRes","RemReadRes");
            /*
         } // if satisfied
      ...
      /*
      else if (d.msg->isSpeculative)
		{
         ...
         AutoDetermineDestSendMsg(forward,d.msg->originalRequestingNode,remoteSendTime,
               &OriginDirectory::OnDirectoryBlockResponse,"LocReadRes","DBRes");
		}
      */
      else
      {
         ...
         if (d.msg->isNonBusySharedRead)
         {
            ...
            AutoDetermineDestSendMsg(toDir,directoryNode,remoteSendTime,
               &OriginDirectory::OnRemoteReadResponse,"LocReadRes","RemReadRes");
         }
         */
      }
      ...
      EM().DisposeMsg(m);
      return;
	} // OriginDirectory::OnLocalReadResponse()

	void OriginDirectory::OnLocalWrite(const BaseMsg* msgIn)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnLocalEviction(const BaseMsg* msgIn)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnLocalInvalidateResponse(const BaseMsg* msgIn)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnRemoteRead(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Read)
      ReadMsg* m = (ReadMsg*)msgIn;
	...
	} // OriginDirectory::OnRemoteRead()

	void OriginDirectory::OnRemoteReadResponse(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_ReadResponse)
      ReadResponseMsg* m = (ReadResponseMsg*)msgIn;
      ...
      if (src == memoryNodeCalc->CalcNodeID(m->addr))
      {
         ...
         AutoDetermineDestSendMsg(newMsg,i->sourceNode,remoteSendTime,
            &OriginDirectory::OnDirectoryBlockResponse,"RemReadRes","DBRes");
         /*
      ...
      */
      ...
      {// a node was read before OnRemoteInvalidateResponse transfers data from the old node
         ...
         if (isPendingDirectoryExclusiveReads)
         {
            ...
            //AutoDetermineDestSendMsg(read,src,remoteSendTime,&OriginDirectory::OnRemoteRead,
            //   "RemReadRes","RemRead");
         }
         else if (isPendingDirectorySharedReads)
         {
            ...
            */
            ...
            AutoDetermineDestSendMsg(read,previousOwner,lookupTime+remoteSendTime,
               &OriginDirectory::OnRemoteRead,"RemReadRes","RemRead");
               */
            ...
            AutoDetermineDestSendMsg(speculativeRequest,src,localSendTime,
               &OriginDirectory::OnRemoteSpeculativeReadResponse,"DirBlkReqShRead","RemoteSpecReadRes");
               */
         }
   ...
   */
   /*
   void OriginDirectory::OnRemoteSpeculativeReadResponse(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_ReadResponse)
      ReadResponseMsg* m = (ReadResponseMsg*)msgIn;
   ...
   */
   void OriginDirectory::OnRemoteUnrequestedReadResponse(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
	...
	void OriginDirectory::OnRemoteWrite(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Write)
      WriteMsg* m = (WriteMsg*)msgIn;
	...
	void OriginDirectory::OnRemoteWriteResponse(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnRemoteEviction(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Eviction)
      EvictionMsg* m = (EvictionMsg*)msgIn;
      ...
      {// if directory state is Busy-shared, transitions to shared, a shared response is returned to
         ...
         //{
            ...
            AutoDetermineDestSendMsg(sharedResponse,b.owner,remoteSendTime,
               &OriginDirectory::OnDirectoryBlockResponse,"RemEvic","DBRes");
         //}
         ...
         AutoDetermineDestSendMsg(busyAck,src,remoteSendTime,
            &OriginDirectory::OnRemoteEvictionResponse,"RemEvic","RemEvicRes");
      ...
      {// if directory state is Exclusive with requestor as owner,
         ...
         AutoDetermineDestSendMsg(rm,src,remoteSendTime,&OriginDirectory::OnRemoteEvictionResponse
      ...
      else
		{
         ...
         //if (b.sharers.size()==0)
         {
            ...
            AutoDetermineDestSendMsg(forward,b.owner,remoteSendTime,
               &OriginDirectory::OnRemoteUnrequestedReadResponse,"RemEvic","RemUnreqReadRes");
         }
...
#endif
	} // OriginDirectory::OnRemoteEviction

	void OriginDirectory::OnRemoteEvictionResponse(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
   ...
   void OriginDirectory::OnRemoteEvictionBusyAck(const BaseMsg* msgIn, NodeID src)
	{
      DebugFail("should not be here");
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnRemoteInvalidate(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
	...
	void OriginDirectory::OnRemoteInvalidateResponse(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_InvalidateResponse)
      InvalidateResponseMsg* m = (InvalidateResponseMsg*)msgIn;
   ...
   void OriginDirectory::OnRemoteMemAccessComplete(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
         ...
         i < pendingMainMemAccessesVector.end(); i++)
      {
         ...
         AutoDetermineDestSendMsg(response,i->sourceNode,remoteSendTime+lookupTime,
            &OriginDirectory::OnDirectoryBlockResponse,"RemMemAccCom","DBRes");
         */
      }
   ...
   void OriginDirectory::OnRemoteInterventionComplete(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
   ...
   void OriginDirectory::OnRemoteInvalidationComplete(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
      ...
      */
      ...
      AutoDetermineDestSendMsg(response,ld.sourceNode,remoteSendTime,
         &OriginDirectory::OnDirectoryBlockResponse,"RemInvCom","DBRes");
         */
   ...
   void OriginDirectory::OnRemoteReadComplete(const BaseMsg* msgIn, NodeID src)
   {
      DebugAssert(msgIn)
      ...
      printDirectoryData(m->addr,m->solicitingMessage);
#endif
   } // OriginDirectory::OnRemoteReadComplete

	void OriginDirectory::OnDirectoryBlockRequest(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Read)
      ReadMsg* m = (ReadMsg*)msgIn;
   ...
   void OriginDirectory::OnDirectoryBlockRequestSharedRead(const BaseMsg *msgIn, NodeID src)
   {
      DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Read)
      ReadMsg* m = (ReadMsg*)msgIn;
      ...
      if ((b.owner==InvalidNodeID&&b.sharers.size()==0) || (b.owner==src&&b.sharers.size()==0))
      {
         ...
         {// if owner is src and it already has block, then just send exclusive reply
            ...
            AutoDetermineDestSendMsg(forward,src,lookupTime+remoteSendTime,
               &OriginDirectory::OnDirectoryBlockResponse,"DirBlkReqShRead","DBRes");
         } // else if (b.owner==src)
         else
         {
      ...
      {// if directory state is Exclusive with another owner, transitions to Busy-shared with
         ...
         AutoDetermineDestSendMsg(read,previousOwner,localSendTime,
            &OriginDirectory::OnRemoteRead,"DirBlkReqShRead","RemRead");
   ...
   void OriginDirectory::OnDirectoryBlockRequestExclusiveRead(const BaseMsg *msgIn, NodeID src)
   {
      DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_Read)
      ReadMsg* m = (ReadMsg*)msgIn;
      ...
      if ((b.owner==InvalidNodeID&&b.sharers.size()==0) || (b.owner==src&&b.sharers.size()==0))
      {
         ...
         {// if owner is src and it already has block, then just send exclusive reply
            ...
            AutoDetermineDestSendMsg(forward,src,lookupTime+remoteSendTime,
               &OriginDirectory::OnDirectoryBlockResponse,"DirBlkReqExRead","DBRes");
         } // else if (b.owner==src)
         else
         {
            DebugFail("b.owner has to be src or InvalidNodeID");
      ...
      {// if directory state is shared, transition to Exclusive and a exclusive reply with invalidates pending
         ...
         if (invalidateLock.find(m->addr)!=invalidateLock.end())
         {
            ...
            AutoDetermineDestSendMsg(rrm, src, remoteSendTime,
               &OriginDirectory::OnDirectoryBlockResponse,"DirBlkExRead","DBRes");
            return;
         }
         ...
         for (HashSet<NodeID>::iterator i = b.sharers.begin(); i!=b.sharers.end(); i++)
         {
            ...
            AutoDetermineDestSendMsg(invalidation,*i,lookupTime+remoteSendTime,
               &OriginDirectory::OnRemoteInvalidate,"DirBlkReqExRead","RemoteInv");
         }
      ...
      {// if directory state is Exclusive with another owner, transitions to Busy-exclusive with
         ...
         AutoDetermineDestSendMsg(read,previousOwner,lookupTime+remoteSendTime,
            &OriginDirectory::OnRemoteRead,"DirBlkReqExRead","RemRead");
	...
	void OriginDirectory::OnDirectoryBlockResponse(const BaseMsg* msgIn, NodeID src)
	{
		DebugAssert(msgIn)
      DebugAssert(msgIn->Type()==mt_ReadResponse)
      ReadResponseMsg* m = (ReadResponseMsg*)msgIn;
      ...
      else
      {
         ...
         if (m->isWaitingForInvalidateUnlock)
         {
            ...
            AutoDetermineDestSendMsg(rcm, directoryNode, remoteSendTime,
               &OriginDirectory::OnRemoteReadComplete,"DBRes","RemReadCom");
         }
		} // else m is not from eviction
	} //OriginDirectory::OnDirectoryBlockResponse
